...
activities = {
    ...
    "Art Club": {
        "description": "Explore various art techniques including painting, drawing, and sculpting",
    ...
    "Science Bowl": {
        "description": "Compete in academic science competitions covering biology, chemistry, and physics",
